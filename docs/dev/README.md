...
- **不改向未入库的本地文件**：`CONTEXT.md`、`AGENTS.md`、`CLAUDE.md`、`INSPIRATION.md`、`docs/archive/` 都在 `.gitignore` 里，克隆仓库的人看不到它们。本目录文档**不得用 markdown 链接指向这些路径**——链接在仓库里是死链。需要引用其中的内容时，把必要的那部分**以文本形式写进本文档**，只把本地文件当作本地环境的参考，而不是文档依赖。
