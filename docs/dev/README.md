...
| 横切机制 | [Tooltip 格式规范](tooltip.md) | 物品/Jade 文本五段式结构、语义色表与本地化键命名的唯一权威 |
...
| 玩法子系统 | [淘洗系统](panning.md) | 淘盘 / 闪烁的光 / 生成与账本 / 淘洗结算 / 淘洗客户端表现 |
| 玩法子系统 | [附魔系统](enchantment.md) | 附魔效果框架 / 四种附魔 / 失落书页锻造 / 附魔揭示 |
| 玩法子系统 | [方块与物品](blocks-items.md) | 可疑方块 / 陶轮 / 标本箱 / 便携容器机制 / 自定义配方 |
...
| 新增 / 修改物品 tooltip 或 Jade 文本 | [Tooltip 格式规范](tooltip.md) 第 2、7 节 |
