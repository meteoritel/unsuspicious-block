...
- 未潜行时无法直接破坏可疑方块（1.5.2 起），防止误把还没刷拭的战利品方块挖掉。
...
村庄武器匠房屋的箱子有 30% 概率出现标本箱。它是一个拥有 5 格空间的便携容器：右键打开，悬停时可以预览内容，放在背包或饰品栏中时，箱内需要“随身携带”或“装备”才能生效的物品仍可正常工作。箱内的不死图腾也会在持有者死亡时自动生效（1.5.2 起），效果与手持图腾一致。
